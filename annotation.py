...
# 将训练集、验证集、测试集数据信息，分别写入model/2007_train.txt、model/2007_val.txt、model/2007_test.txt
...
def write_txt():
    ...
    write_each_txt(train_file, '2007_train.txt')
    write_each_txt(val_file, '2007_val.txt')
    write_each_txt(test_file, '2007_test.txt')
